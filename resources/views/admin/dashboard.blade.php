                                ...
                                <ul class="timeline">
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                            ...
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic1.jpg') }}">
                                            <div class="col">
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                            href="javascript:void(0);">
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic2.jpg') }}">
                                            <div class="col">
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                            href="javascript:void(0);">
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic3.jpg') }}">
                                            <div class="col">
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                            href="javascript:void(0);">
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic4.jpg') }}">
                                            <div class="col">
                                                <h5 class="mb-1">Dr sultads Send you Photo</h5>
                                                <small class="d-block">29 July 2021 - 02:26 PM</small>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                            href="javascript:void(0);">
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic5.jpg') }}">
                                            <div class="col">
                                                <h5 class="mb-1">Resport created successfully</h5>
                                                <small class="d-block">29 July 2021 - 02:26 PM</small>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                            href="javascript:void(0);">
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic6.jpg') }}">
                                            <div class="col">
                                                <h5 class="mb-1">Reminder : Treatment Time!</h5>
                                                <small class="d-block">29 July 2021 - 02:26 PM</small>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                            href="javascript:void(0);">
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic7.jpg') }}">
                                            <div class="col">
                                                <h5 class="mb-1">Dr sultads Send you Photo</h5>
                                                <small class="d-block">29 July 2021 - 02:26 PM</small>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                            href="javascript:void(0);">
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic8.jpg') }}">
                                            <div class="col">
                                                <h5 class="mb-1">Resport created successfully</h5>
                                                <small class="d-block">29 July 2021 - 02:26 PM</small>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                            href="javascript:void(0);">
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic9.jpg') }}">
                                            <div class="col">
                                                <h5 class="mb-1">Reminder : Treatment Time!</h5>
                                                <small class="d-block">29 July 2021 - 02:26 PM</small>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted d-flex align-items-center"
                                            href="javascript:void(0);">
                                            <img class="rounded-circle" alt="image" width="50"
                                                src="{{ asset('admin/assets/images/profile/education/pic10.jpg') }}">
                                            <div class="col">
                                                <h5 class="mb-1">Dr sultads Send you Photo</h5>
                                                <small class="d-block">29 July 2021 - 02:26 PM</small>
                                            </div>
                                                    ...
                                                    <div class="media d-flex align-items-center">
                                                        <div class="avatar avatar-xl mr-2">
                                                            <img class="rounded-circle img-fluid"
                                                                src="{{ asset('admin/assets/') }}imag/es/avatar5.png"
                                                                width="30" alt="" />
                                                        </div>
                                            ...
                                            <td class="p-3">
                                                <a href="javascript:void(0);">
                                                    <div class="media d-flex align-items-center">
                                                        <div class="avatar avatar-xl mr-2">
                                                            <img class="rounded-circle img-fluid"
                                                                src="{{ asset('admin/assets/images/avatar/5.png') }}"
                                                                width="30" alt="" />
                                                        </div>
                                                        <div class="media-body">
